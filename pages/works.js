        ...
        <Container>
            ...
            <SimpleGrid columns={[1,1,2]} gap={6}>
                ...
                <Section delay={0.4}>
                    <WorkGridItem 
                    id="ehp" 
                    title="Ethical Hacker's Website" 
                    thumbnail={ehp}>
                ...
                <Section delay={0.4}>
                    ...
                    A second brain note taking repoistory
                    </WorkGridItem>
                </Section>
                <Section delay={0.4}>
                    <WorkGridItem 
            ...
            <SimpleGrid columns={[1,1,2]} gap={6}>
                <Section delay={0.4}>
                <p>First collab incoming. Keep an eye out ;)</p>
                </Section>
            </SimpleGrid>
            <Divider my={6}/>
            ...
            <SimpleGrid columns={[1,1,2]} gap={6}>
                <Section delay={0.4}>
                    ...
                    thumbnail={oldsite}>
                    An original website made with no fameworks
                    </WorkGridItem>
                </Section>
                <Section delay={0.4}>
                    <WorkGridItem 
                ...
                <Section delay={0.4}>
                    ...
                    title="Computer" 
                    thumbnail={computer}>
                    A custom computer and workstation for a homelab
                    </WorkGridItem>
                </Section>
            </SimpleGrid>
